  ...
  return (
    <div className="footer">
      ...
      <div className="footer_container">
        <div className="footer_leftContainer">
          <p className="footer_description">
            Our products are known for more than their quality, craftsmanship,
            and tone. They are backed by our unwavering commitment to
            environmental sustainability and responsible manufacturing
            practices.
          </p>
            ...
            <ul className="footer_socialList">
              <li>
                <a
                  ...
                  target="_blank"
                  className="footer_socialInstagram"
                >
                  <InstagramIcon />
                </a>
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  className="footer_socialFacebook"
                >
                  <FacebookIcon />
                </a>
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  className="footer_socialTwitter"
                >
                  <TwitterIcon />
                </a>
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  className="footer_socialYoutube"
                >
                  <YouTubeIcon />
                </a>
              </li>
      ...
      <p className="footer_footer">
        @2022 The Guitar Store All Rights Reserved
      </p>
    </div>
  );
}
