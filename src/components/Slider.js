  ...
  return (
    <div className='slider'>
        ...
        <div className='slider_container'>
            <div className='slider_subcontainer' style={{ transform: `translateX(${-index*100}%)`}}>
              <div className='slider_imageContainer'>
                <img src={new_models} alt=" " className='slider_image1' />
              </div><div className='slider_infoContainer'>
            ...
            <div className='slider_subcontainer' style={{ transform: `translateX(${-index*100}%)`}}>
              <div className='slider_imageContainer'>
                ...
                <div className='slider_infoContent'>
                  <h1 className='slider_infoTitle'>D'Addario Acoustic Guitar Strings</h1>
            ...
            <div className='slider_subcontainer' style={{ transform: `translateX(${-index*100}%)`}}>
              <div className='slider_imageContainer'>
                ...
                <div className='slider_infoContent'>
                  ...
                  <Link to={"/guitars/6229061e25b86df054fe9605"} className='slider_infoButtonContainer'>
                    <button className='slider_infoButton'>SHOP NOW</button>
                  </Link>
                </div>                
              </div>
            ...
            <div className="slider_slideshowDots">
                  {colors.map((_, idx) => (
                    <div
                      key={idx}
                      className={`slider_slideshowDot${index === idx ? " slider_active" : ""}`}
                      onClick={() => {
                        setIndex(idx);
                      }}
                    >
