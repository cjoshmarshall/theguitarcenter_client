        ...
        {cart.products.length >= 1 ? (
          <div className="cart_container">
            <div className="cart_subcontainer">
              ...
              <p className="cart_card" onClick={handleReset}>
                Remove All
              </p>
              {cart.products.map((product) => (
                <div className="cart_innercontainer1" key={product._id}>
                  <div className="cart_infoContainer">
                    <img src={product.image} alt=" " className="cart_image" />
          ...
          <div className="cart_innercontainer3">
            ...
            <Link to="/guitars">
              <button className="cart_infoButton">Shop Now</button>
            </Link>
          </div>
        )}
      </div>
