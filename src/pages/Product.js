        ...
        <div className='product_container'>
            ...
            <div className='product_infoContainer'>
                ...
                <div className='product_infoButtons'>
                    <button className='product_infoNoButton' onClick={()=>handleQuantity("decrement")}>-</button>
                    <p className='product_infoNo'>{quantity}</p>
                    <button className='product_infoNoButton' onClick={()=>handleQuantity("increment")}>+</button>
                  <button className='product_infoButton' onClick={handleSubmit}>ADD TO CART</button>
                </div>
            </div>
        </div>
        <Component2 />
