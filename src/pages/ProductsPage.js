      ...
      <div>
        ...
        <div className='productsPage_container'>
          <div className='productsPage_filterContainer'>
            <select className='productsPage_filterSelect' onClick={e=>setSort(e.target.value)}>
            ...
            <h3 className='productsPage_subtitle'>SERIES</h3>
              <ul className='productsPage_filterList2' onChange={handleFilter}>
                <li className='productsPage_filterListsButton'>
                    <Checkbox  name='series' id='1' value='Little' disableRipple checked={false} sx={{
                        color: grey[900],
                ...
                <li className='productsPage_filterLists2'>
                  <button className='productsPage_filterListsButton' >
                    <Checkbox  name='series' id='2' value='X' disableRipple checked={false} sx={{
                        color: grey[900],
                        '&.Mui-checked': {color: grey[900]}
                      }}
                    />
                ...
                <li className='productsPage_filterLists2'>
                  <button className='productsPage_filterListsButton' >
                    <Checkbox  name='series' id='3' value='Standard' disableRipple checked={false} sx={{
                        color: grey[900],
                        '&.Mui-checked': {color: grey[900]}
                      }}
                    />
                ...
                <li className='productsPage_filterLists2'>
                  <button className='productsPage_filterListsButton' >
                    <Checkbox  name='series' id='4' value='Modern Deluxe' disableRipple checked={false} sx={{
                        color: grey[900],
                        '&.Mui-checked': {color: grey[900]}
                      }}
                    />
